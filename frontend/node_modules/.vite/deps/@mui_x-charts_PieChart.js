import {
  ...
  useThemeProps
} from "./chunk-VPDFCW63.js";
import "./chunk-22XADDE5.js";
import {
  _extends,
  composeClasses,
  ...
  useRtl,
  useTheme
} from "./chunk-HVCAW2LW.js";
import {
  clsx_default
} from "./chunk-VEB3A3D5.js";
import {
  require_jsx_runtime
} from "./chunk-I3M7O5M6.js";
import {
  require_react
} from "./chunk-FC4XHZFC.js";
import {
  __commonJS,
  __publicField,
  __toESM
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React54 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState5 = React54.useState, useEffect17 = React54.useEffect, useLayoutEffect = React54.useLayoutEffect, useDebugValue = React54.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React54 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore2 = shim.useSyncExternalStore, useRef14 = React54.useRef, useEffect17 = React54.useEffect, useMemo11 = React54.useMemo, useDebugValue = React54.useDebugValue;
...
var useChartInteractionListener = ({
  ...
  const gestureManagerRef = React7.useRef(null);
  React7.useEffect(() => {
  ...
  const addInteractionListener = React7.useCallback((interaction, callback, options) => {
    const svg = svgRef.current;
  ...
  const updateZoomInteractionListeners = React7.useCallback((interaction, options) => {
    const svg = svgRef.current;
    const gestureManager = gestureManagerRef.current;
...
var selectorChartsTooltipItemIsDefined = createSelector2(selectorChartsLastInteraction, selectorChartsTooltipPointerItemIsDefined, selectorChartsKeyboardItemIsDefined, (lastInteraction, pointerItemIsDefined, keyboardItemIsDefined) => lastInteraction === "keyboard" ? keyboardItemIsDefined : pointerItemIsDefined);
...
function usePieSeriesLayout() {
  const store = useStore2();
  const seriesLayout2 = useSelector(store, selectorChartSeriesLayout);
...
function useChartGradientIdBuilder() {
  ...
  return React21.useCallback((axisId) => `${chartId}-gradient-${axisId}`, [chartId]);
}
function useChartGradientIdObjectBoundBuilder() {
  const chartId = useChartId2();
  return React21.useCallback((axisId) => `${chartId}-gradient-${axisId}-object-bound`, [chartId]);
}
...
function useAnimateInternal(props, {
  ...
  const setRef = React22.useCallback((element) => {
    var _a, _b, _c, _d;
    if (element === null) {
...
var ChartsLocalizationContext = React23.createContext(null);
...
function ChartsLocalizationProvider(inProps) {
  ...
  } = React23.useContext(ChartsLocalizationContext) ?? {
    localeText: void 0
  };
  ...
  const localeText = React23.useMemo(() => _extends({}, DEFAULT_LOCALE, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
...
var useChartsLocalization = () => {
  const localization = React24.useContext(ChartsLocalizationContext);
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React26.useMemo(() => ({
...
function useFocusedItem() {
  ...
  return React33.useMemo(() => focusedSeriesType === void 0 || focusedSeriesId === void 0 || focusedDataIndex === void 0 ? null : {
...
var useInteractionItemProps = (data, skip) => {
  ...
  const interactionActive = React34.useRef(false);
...
var _excluded11 = ["className", "classes", "color", "dataIndex", "id", "isFaded", "isHighlighted", "isFocused", "onClick", "cornerRadius", "startAngle", "endAngle", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "stroke", "skipInteraction"];
...
var PieArc = React35.forwardRef(function PieArc2(props, ref) {
  const {
    className,
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React36.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PieArcPlot(props) {
  ...
  const focusedItem = dataIndex !== void 0 && seriesId === id && seriesType === "pie" ? transformedData[dataIndex] : null;
  if (data.length === 0) {
    return null;
  }
  const Arc = (slots == null ? void 0 : slots.pieArc) ?? PieArc;
  return (0, import_jsx_runtime16.jsxs)("g", _extends({}, other, {
    ...
    }, slotProps == null ? void 0 : slotProps.pieArc), item.dataIndex)), focusedItem && (0, import_jsx_runtime16.jsx)(Arc, {
...
var _excluded13 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "skipAnimation"];
...
var PieArcLabel = React38.forwardRef(function PieArcLabel2(props, ref) {
  const {
    id,
    classes: innerClasses,
    color: color2,
...
var ChartsSurface = React43.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore2();
...
var ChartsSlotsContext = React44.createContext(null);
if (true) ChartsSlotsContext.displayName = "ChartsSlotsContext";
function useChartsSlots() {
  const context = React44.useContext(ChartsSlotsContext);
  if (context == null) {
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React47.cloneElement(render, props);
  }
  return React47.createElement(defaultElement, props);
}
...
function ToolbarContextProvider({
  ...
  return (0, import_jsx_runtime30.jsx)(ToolbarContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React49.useRef(disabled);
  React49.useEffect(() => {
  ...
  const previousAriaDisabled = React49.useRef(ariaDisabled);
  React49.useEffect(() => {
...
var _excluded20 = ["className", "render"];
...
var Toolbar = React50.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
  ...
  return (0, import_jsx_runtime31.jsx)(ToolbarContextProvider, {
    children: element
  });
});
...
true ? Toolbar.propTypes = {
   ...
   */
  render: import_prop_types19.default.oneOfType([import_prop_types19.default.element, import_prop_types19.default.func])
} : void 0;
...
var _excluded21 = ["render", "onKeyDown", "onFocus", "disabled", "aria-disabled"];
var _excluded23 = ["tabIndex"];
var ToolbarButton = React51.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
...
true ? ChartsWrapper.propTypes = {
   ...
   * @default false
   */
  hideLegend: import_prop_types21.default.bool,
  /**
...
var PIE_CHART_PLUGINS = [useChartTooltip, useChartInteraction, useChartHighlight, useChartKeyboardNavigation];

// node_modules/@mui/x-charts/esm/PieChart/PieChart.js
var import_jsx_runtime34 = __toESM(require_jsx_runtime(), 1);
var _excluded24 = ["series", "width", "height", "margin", "colors", "sx", "skipAnimation", "hideLegend", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar"];
var PieChart = React53.forwardRef(function PieChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime34.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime34.jsxs)(ChartsWrapper, {
      ...
      children: [showToolbar && Toolbar3 ? (0, import_jsx_runtime34.jsx)(Toolbar3, _extends({}, (_f = props.slotProps) == null ? void 0 : _f.toolbar)) : null, !hideLegend && (0, import_jsx_runtime34.jsx)(ChartsLegend, {
        direction: ((_h = (_g = props.slotProps) == null ? void 0 : _g.legend) == null ? void 0 : _h.direction) ?? "vertical",
        slots,
        slotProps
      }), (0, import_jsx_runtime34.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime34.jsx)(PiePlot, {
          slots,
          slotProps,
          onItemClick
      ...
      })), !loading && (0, import_jsx_runtime34.jsx)(Tooltip, _extends({
        trigger: "item"
...
true ? PieChart.propTypes = {
  ...
  enableKeyboardNavigation: import_prop_types22.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * If `true`, the legend is not rendered.
   */
  hideLegend: import_prop_types22.default.bool,
  /**
   ...
   * @default false
   */
  showToolbar: import_prop_types22.default.bool,
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
